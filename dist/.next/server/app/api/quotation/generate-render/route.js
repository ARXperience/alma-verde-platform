...
Responde de manera conversacional y \xfatil.`;function g(a,b){let c=a;for(let[a,d]of Object.entries(b)){let b=`{${a}}`,e="object"==typeof d?JSON.stringify(d,null,2):String(d);c=c.replace(RegExp(b,"g"),e)}return c}},78335:()=>{},86439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},96487:()=>{}};var b=require("../../../../webpack-runtime.js");b.C(a);var c=b.X(0,[3445,1813,747],()=>b(b.s=49294));module.exports=c})();