...
import { Loader2, Upload, X, ArrowLeft, Trash2, ShoppingBag, RotateCcw } from 'lucide-react'
...
export default function EditProductPage() {
    ...
    async function fetchProduct() {
        try {
            ...
            setRentalPrice(product.rental_price ? product.rental_price.toString() : '')
            setCategory(product.category)
            setBusinessUnit(product.business_unit)
            setInStock(product.in_stock)
            setStockQuantity(product.stock_quantity ? product.stock_quantity.toString() : '')
            setImages(product.images || [])
            setIsRental(product.is_rental || false)
        } catch (error) {
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center min-h-screen bg-[#f6f8f6] dark:bg-[#102216]">
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight">Editar Producto</h1>
                    </div>

                    <AlertDialog>
                        <AlertDialogTrigger asChild>
                            <Button variant="destructive" disabled={deleting} className="bg-red-50 hover:bg-red-100 text-red-600 border-red-200 dark:bg-red-900/10 dark:hover:bg-red-900/20 dark:text-red-500 dark:border-red-900/30 rounded-lg">
                                <Trash2 className="h-4 w-4 mr-2" />
                                Eliminar Producto
                            </Button>
                        </AlertDialogTrigger>
                        <AlertDialogContent className="bg-white dark:bg-[#152e1e] border-gray-100 dark:border-[#1e402a]">
                            <AlertDialogHeader>
                            ...
                            <AlertDialogFooter>
                                <AlertDialogCancel className="border-gray-200 dark:border-[#1e402a] text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#1e402a]">Cancelar</AlertDialogCancel>
                    ...
                    <CardContent className="pt-8">
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="flex justify-end gap-4 pt-6 mt-8 border-t border-gray-100 dark:border-[#1e402a]">
                                ...
                                <Button type="submit" disabled={saving} className="bg-[#13ec5b] hover:bg-[#13ec5b]/90 text-[#111813] font-bold shadow-md rounded-xl px-8">
