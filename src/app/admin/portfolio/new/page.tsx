...
import { Loader2, ArrowLeft, Save, Plus, X, Star, Globe, ImageIcon } from 'lucide-react'
    ...
    return (
        <div className="p-8 max-w-5xl mx-auto">
            <div className="flex items-center gap-4 mb-10">
                ...
                <div>
                    <h1 className="text-4xl font-black text-[#102216] tracking-tight">Nuevo Proyecto</h1>
                    <p className="text-slate-500 mt-1 text-lg">Crea un proyecto propio de Alma Verde para el portafolio</p>
                </div>
            </div>
                    ...
                    <CardHeader className="border-b border-slate-100 bg-slate-50/50 pb-6">
                        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                            <div>
                                ...
                                <CardDescription className="text-slate-500 mt-1">Sube las fotos del proyecto. La primera será la imagen principal.</CardDescription>
                            </div>
                            <div>
                                <input
                                    type="file"
